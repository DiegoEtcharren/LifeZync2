...
class RegistroController {
    ...
    public static function crear(Router $router) {
        ...
        // Verificar si el usuario ya hizo un registro existoso: 
    ...
    public static function conferencias(Router $router) {
        ...
        // Redireccionar a boleto virtual en caso de haber finalizado registro:
        ...
        foreach ($eventos as $evento) {
            ...
            if ($evento->dia_id == '1' && $evento->categoria_id == '2') {
                $eventos_formateado['workshop_v'][] = $evento; 
            } 
            ...
            if ($evento->dia_id == '2' && $evento->categoria_id == '2'){
                $eventos_formateado['workshop_s'][] = $evento;
            }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            foreach ($eventos as $evento_id) {
                ...
                // Comprobar que si exista el evento: 
